# Домашнее задание к лекции «Unit-тестирование»[![Build status](https://ci.appveyor.com/api/projects/status/ro5ux9ylfplst8m0?svg=true)](https://ci.appveyor.com/project/CarolineFell/unit-test)
